...
[data-testid="stSidebar"] .stRadio label{color:#F0FFF4 !important;}
...
def transcribe_audio_gemini(audio_bytes, language_hint="English"):
    ...
    _lang_prompts = {
        ...
        "Tigrinya": (
            "IMPORTANT: This audio is in TIGRINYA (ትግርኛ) — a Semitic language "
            "spoken in Eritrea and the Tigray region of Ethiopia. "
            "It is NOT Arabic, NOT Amharic. "
            "Common Tigrinya words: selam, hamot, timirti, hagaz, enda, kem, "
            "wetset, ezi, yibelwo, koyne, nihna, anta, izi. "
            "Transcribe the Tigrinya exactly. "
            "Do NOT translate to Arabic or Amharic. "
            "Return ONLY the Tigrinya transcription."
        ),
        "Runyankole": (
            "IMPORTANT: This audio is in RUNYANKOLE (Runyakitara) — "
            "a Bantu language spoken in western Uganda, Ankole region. "
            "It is NOT Luganda and NOT Swahili. "
            "Common Runyankole words: agandi, osiibe, omulimu, sente, "
            "okutura, kuhiiga, omushaho, emboga, ente, oraire. "
            "Transcribe exactly. Do NOT switch to Luganda or Swahili. "
            "Return ONLY the Runyankole transcription."
        ),
        "Luganda": (
...
def process_audio_direct(audio_bytes, language_name, user_profile,
    ...
    try:
        ...
        elif language_name == "Tigrinya":
            lang_instr = (
                "The user is speaking in TIGRINYA (ትግርኛ) — spoken in Eritrea "
                "and Ethiopia. NOT Arabic. NOT Amharic. "
                "Listen to their Tigrinya audio and understand their question."
            )
        elif language_name == "Runyankole":
            lang_instr = (
                "The user is speaking in RUNYANKOLE (Runyakitara) — "
                "a Bantu language from western Uganda. NOT Luganda. NOT Swahili. "
                "Listen to their Runyankole audio and understand their question."
            )
...
UI_STRINGS = {
    "English": {
        ...
        "sign_out":          "🚪 Sign Out",
        "svc_opportunities": "🎯 Opportunities",
        "svc_success":       "⭐ Success Stories",
        "svc_literacy":      "📚 Financial Literacy",
        "svc_stage_filter":  "Filter by stage:",
        "svc_all_stages":    "All Stages",
    },
    "Swahili": {
        "lang_label":        "🌍 Lugha:",
        ...
        "sign_out":          "🚪 Toka",
        "svc_opportunities": "🎯 Fursa",
        "svc_success":       "⭐ Hadithi za Mafanikio",
        "svc_literacy":      "📚 Elimu ya Fedha",
        "svc_stage_filter":  "Chuja kwa hatua:",
        "svc_all_stages":    "Hatua Zote",
    },
    "Arabic": {
        "lang_label":        "🌍 اللغة:",
        ...
        "svc_opportunities": "🎯 الفرص",
        "svc_success":       "⭐ قصص النجاح",
        "svc_literacy":      "📚 الثقافة المالية",
        "svc_stage_filter":  "تصفية حسب المرحلة:",
        "svc_all_stages":    "جميع المراحل",
    },
    "Tigrinya": {
        "lang_label":         "🌍 ቋንቋ:",
        "greeting_morning":   "ጽቡቕ ጽባሕ",
        "greeting_afternoon": "ጽቡቕ ድሕሪ ቀትሪ",
        "greeting_evening":   "ጽቡቕ ምሸት",
        "welcome_back":       "ብደሓን ተመሊስካ",
        "welcome_new":        "ናብ Katali ብደሓን!",
        "setup_profile":      "👆 **ፕሮፋይልካ ምልኣ** ናይ ዝቀርቡልካ ዕድላትን ሓገዛትን ምእንቲ ትርኢ።",
        "setup_btn":          "✏️ ፕሮፋይለይ ምልኣ →",
        "stat_grants":        "ንኣኻ ዘሎ ሓገዛት",
        "stat_bps":           "ናይ ቢዝነስ ሞደላት",
        "stat_lessons":       "ትምህርታዊ ኣርእስቲ",
        "grants_heading":     "🏆 ንኣኻ ዝምጥን ሓገዛት",
        "grants_available":   "🏆 ዝርከቡ ሓገዛትን ፕሮግራምትን",
        "matched_to":         "ዝተሓሓዘሉ:",
        "who_qualifies":      "✅ መን ይሰማምዕ",
        "cost":               "💰 ዋጋ",
        "bps_heading":        "💡 ናይ ቢዝነስ ሓሳባት",
        "quick_tip":          "💡 ቕልጡፍ ምኽሪ",
        "learning_heading":   "📚 ናይ ሎሚ ትምህርቲ",
        "fin_lit":            "ናይ ገንዘብ ፍልጠት",
        "do_today":           "✅ ሎሚ ኣዚ ግበር",
        "ask_heading":        "🎤 ዝደለኻዮ ሕተቱና",
        "ask_caption":        "ተዛረብ ወይ ጸሓፍ — ኣብ ኩሉ ሓገዛትን ፕሮግራምትን ንደሊ።",
        "mic_prompt":         "🎤 ማይክሮፎን ተጭን ብ",
        "type_prompt":        "ወይ ሕቶኻ ኣብዚ ጸሓፍ:",
        "placeholder":        "ኣብ ካምፓላ ቢዝነስ ንዝጅምሩ ደቀነስትዮ ዘሎ ሓገዛት እንታይ ኣሎ?",
        "find_btn":           "🔍 ዝምጥነኒ ርከብ",
        "found_heading":      "### 💡 ዝረኸብናዮ",
        "translating":        "ትሕዝቶ ይትርጎም ኣሎ…",
        "transcribing":       "ድምጽኻ ይምዝገብ ኣሎ…",
        "you_said":           "ዝበልካዮ:",
        "transcribe_fail":    "⚠️ ድምጽኻ ምምዝጋብ ኣይተኻእለን። ጋና ፈትን ወይ ጸሓፍ።",
        "type_first":         "ቅድሚ ኩሉ ሕቶ ተዛረብ ወይ ጸሓፍ።",
        "searching":          "ኣብ ሓገዛትን ሞደላትን ንደሊ…",
        "sign_out":           "🚪 ውጻእ",
        "svc_opportunities":  "🎯 ዕድላት",
        "svc_success":        "⭐ ዕወታ ዛንታ",
        "svc_literacy":       "📚 ናይ ገንዘብ ትምህርቲ",
        "svc_stage_filter":   "ብደረጃ ምልቃሕ:",
        "svc_all_stages":     "ኩሉ ደረጃ",
    },
    "Runyankole": {
        "lang_label":         "🌍 Olulimi:",
        "greeting_morning":   "Oraire ota",
        "greeting_afternoon": "Osiibe ota",
        "greeting_evening":   "Bwire obulungi",
        "welcome_back":       "Karibu agyeeyo",
        "welcome_new":        "Karibu kuri Katali!",
        "setup_profile":      "👆 **Jaza profile yawe** okuzindika ebitiibwa n'emikisa erikwata nawe.",
        "setup_btn":          "✏️ Jaza Profile Yange →",
        "stat_grants":        "Ebitiibwa Byawe",
        "stat_bps":           "Endagaano z'Omulimu",
        "stat_lessons":       "Ebishomu by'Okwegyesa",
        "grants_heading":     "🏆 Ebitiibwa n'Emirimu Gyawe",
        "grants_available":   "🏆 Ebitiibwa n'Emirimu Ebinaabako",
        "matched_to":         "Ekikwatana na:",
        "who_qualifies":      "✅ Ani Akwana",
        "cost":               "💰 Omuwendo",
        "bps_heading":        "💡 Ebirowoozo by'Omulimu",
        "quick_tip":          "💡 Ekigambo Eky'Amangu",
        "learning_heading":   "📚 Okwegyesa kw'Erizooba",
        "fin_lit":            "Okumanya Ebya Sente",
        "do_today":           "✅ Kora Kino Erizooba",
        "ask_heading":        "🎤 Tubuuzaho Ekizibu Kyona",
        "ask_caption":        "Gamba nooha wandike — tunoonyeza mu bitiibwa byona, emirimu, n'ebishomu.",
        "mic_prompt":         "🎤 Kuba ku mikrofoni ugambe mu",
        "type_prompt":        "Nooha wandike ekibuuzo kye hano:",
        "placeholder":        "Bitiibwa ki ebinaabako ku bakazi abaatandika omulimu e Kampala?",
        "find_btn":           "🔍 Nonya Ekikwatana Nawe",
        "found_heading":      "### 💡 Kino Ekibaireho Okwetwarira",
        "translating":        "Tukitafsirako ebinaabako…",
        "transcribing":       "Tukimanya ekyo kye wagambire…",
        "you_said":           "Wagamba:",
        "transcribe_fail":    "⚠️ Tetusobire kukimanya. Gezaho kugamba obulungi, nooha wandike.",
        "type_first":         "Gambiriza nooha wandike ekibuuzo edda.",
        "searching":          "Tunoonyeza mu bitiibwa, endagaano, n'ebishomu…",
        "sign_out":           "🚪 Vaamu",
        "svc_opportunities":  "🎯 Emikisa",
        "svc_success":        "⭐ Ebisobore Obulungi",
        "svc_literacy":       "📚 Okwegyesa kw'Ebya Sente",
        "svc_stage_filter":   "Shanga ku Ntandika:",
        "svc_all_stages":     "Entandika Zose",
    },
    "Luganda": {
        "lang_label":        "🌍 Lulimi:",
        ...
        "sign_out":          "🚪 Vaamu",
        "svc_opportunities": "🎯 Emikisa",
        "svc_success":       "⭐ Ebiwangula Obulungi",
        "svc_literacy":      "📚 Okumanya Ssente",
        "svc_stage_filter":  "Sanja mu Ntandika:",
        "svc_all_stages":    "Entandika Zonna",
    },
}
...
# ==================================================================
    ...
    # ── TRANSLATE — 3 calls run in parallel, only what's shown ──────
    if app_lang_name != "English" and _api_key:
        _lessons_to_xlat = all_lessons[:6]   # never translate all 28
        with st.spinner(_s["translating"]):
            with ThreadPoolExecutor(max_workers=3) as _pool:
                _fg = _pool.submit(translate_batch,
                                   json.dumps(matched_grants,     ensure_ascii=False),
                                   app_lang_name, json.dumps(GRANT_FIELDS),  _api_key)
                _fb = _pool.submit(translate_batch,
                                   json.dumps(matched_bps,        ensure_ascii=False),
                                   app_lang_name, json.dumps(BP_FIELDS),     _api_key)
                _fl = _pool.submit(translate_batch,
                                   json.dumps(_lessons_to_xlat,   ensure_ascii=False),
                                   app_lang_name, json.dumps(LESSON_FIELDS), _api_key)
                matched_grants = json.loads(_fg.result())
                matched_bps    = json.loads(_fb.result())
                all_lessons    = json.loads(_fl.result())
    ...
    with tab_services:
        ...
        _svc_opts = [
            _s.get("svc_opportunities", "🎯 Opportunities"),
            _s.get("svc_success",       "⭐ Success Stories"),
            _s.get("svc_literacy",      "📚 Financial Literacy"),
        ]
        svc_cat = st.radio(
            "Category",
            _svc_opts,
        ...
        if svc_cat == _svc_opts[0]:  # Opportunities
            ...
            for card in matched_grants:
                ...
                with st.expander(f"**{card.get('title','')}**  ·  {badge}"):
                    ...
                    # ── Citizen actions ───────────────────────────
                    st.write("")
                    _cid = card.get("id", str(matched_grants.index(card)))
                    btn_col1, btn_col2, btn_col3 = st.columns(3)
                    with btn_col1:
                        if PDF_AVAILABLE:
                            _pdf = generate_gov_card_pdf(card, profile)
                            if _pdf:
                                st.download_button(
                                    "📄 Download PDF",
                                    data=_pdf,
                                    file_name=f"{_cid}_opportunity.pdf",
                                    mime="application/pdf",
                                    key=f"cit_dl_g_{_cid}",
                                    use_container_width=True
                                )
                    with btn_col2:
                        if st.button("👍 Helpful", key=f"cit_yes_{_cid}",
                                     use_container_width=True):
                            st.session_state.feedback_log.append({
                                "timestamp": datetime.now().isoformat(timespec="seconds"),
                                "program": card.get("title",""),
                                "status": "Helpful",
                                "district": profile.get("district","unknown")
                            })
                            try: save_json(FEEDBACK_FILE, st.session_state.feedback_log)
                            except Exception: pass
                            st.success("Thank you! Feedback recorded.")
                    with btn_col3:
                        if st.button("👎 Still unclear", key=f"cit_no_{_cid}",
                                     use_container_width=True):
                            st.session_state.feedback_log.append({
                                "timestamp": datetime.now().isoformat(timespec="seconds"),
                                "program": card.get("title",""),
                            ...
                            st.info("Noted — we'll work to make this clearer.")
            ...
            for bp in matched_bps:
                ...
                with st.expander(f"**{bp.get('title','')}**  ·  {bp.get('tier','')}"):
                    ...
                    # ── PDF download ──────────────────────────────
                    if PDF_AVAILABLE:
                        _bpdf = generate_blueprint_pdf(bp, profile)
                        if _bpdf:
                            st.write("")
                            st.download_button(
                                "📄 Download Blueprint PDF",
                                data=_bpdf,
                                file_name=f"{bp.get('id','bp')}_blueprint.pdf",
                                mime="application/pdf",
                                key=f"cit_dl_bp_{bp.get('id','')}"
                            )
            st.caption(f"{len(all_lessons)} lessons · practical money skills")
            stage_filter = st.selectbox(
                _s.get("svc_stage_filter", "Filter by stage:"),
                [_s.get("svc_all_stages", "All Stages")] + STAGES,
                key="lesson_stage_filter"
            )
            _all_stages_label = _s.get("svc_all_stages", "All Stages")
            filtered = ([m for m in all_lessons
                         if stage_filter == _all_stages_label or
            ...
            for lesson in filtered:
                ...
                with st.expander(f"{lic} **{lesson.get('topic','')}**"):
                    ...
                    # ── PDF download ──────────────────────────────
                    if PDF_AVAILABLE:
                        _lpdf = generate_masterclass_pdf(lesson, profile, "")
                        if _lpdf:
                            st.write("")
                            st.download_button(
                                "📄 Download Lesson PDF",
                                data=_lpdf,
                                file_name=f"{lesson.get('id','fl')}_lesson.pdf",
                                mime="application/pdf",
                                key=f"cit_dl_fl_{lesson.get('id','')}"
                            )
    # ──────────────────────────────────────────────────────────────
    with tab_ask:
...
# ==================================================================
    ...
    if view == "🏛️ Content Management":
        ...
        with cms_tab1:
            st.markdown("### 🎯 Publish a New Opportunity")
            with st.form("cms_gov_form", clear_on_submit=True):
                g_title       = st.text_input("Programme / Service Name:")
                ...
                if st.form_submit_button("🚀 Publish to Registry"):
                    gov_db.append({
                        "id": str(uuid.uuid4())[:8], "title": g_title,
                        "agency": g_agency, "stage": g_stage, "sector": g_sector,
                        "eligibility": g_eligibility, "cost": g_cost,
                        "steps": g_steps, "contacts": g_contacts
                    })
                    save_json(GOV_DB_FILE, gov_db)
                    st.session_state.gov_db = gov_db
                    st.success(f"Published '{g_title}' to the registry.")
                    st.rerun()

            st.write("---")
            st.markdown("### ✏️ Edit Existing Opportunities")
        ...
        with cms_tab2:
            st.markdown("### ⭐ Publish a New Success Story / Blueprint")
            with st.form("cms_blueprint_form", clear_on_submit=True):
                b_title   = st.text_input("Business Model Name:")
                b_sector  = st.selectbox("Industry Sector:", SECTORS, key="b_sector")
                b_tier    = st.selectbox("Capital Tier:", CAPITAL_TIERS)
                b_capital = st.text_input("Capital Required (UGX):")
                b_summary = st.text_area("Business Model Summary:")
                b_fin_lit = st.text_area("Financial Literacy Tip:")
                b_case    = st.text_area("Verified Success Case:")
                b_media   = st.text_input("YouTube / Media Link:")
                if st.form_submit_button("🎬 Publish Success Story"):
                    blueprint_db.append({
                        "id": str(uuid.uuid4())[:8], "title": b_title,
                        "sector": b_sector, "tier": b_tier,
                        "capital_required": b_capital, "summary": b_summary,
                        "fin_lit_tip": b_fin_lit, "success_case": b_case,
                        "media_anchor": b_media
                    })
                    save_json(BLUEPRINT_DB_FILE, blueprint_db)
                    st.session_state.blueprint_db = blueprint_db
                    st.success(f"Published '{b_title}'.")
                    st.rerun()

            st.write("---")
            st.markdown("### ✏️ Edit Existing Success Stories")
        ...
        with cms_tab3:
            st.markdown("### 📚 Publish a New Financial Literacy Note")
            with st.form("cms_masterclass_form", clear_on_submit=True):
                ...
                fl_summary = st.text_area("Lesson (3-4 sentences):", value="Explain the core point in plain language.")
                fl_uganda  = st.text_area("Uganda-Specific Example:", value="Reference a real Ugandan institution or programme.")
                fl_mistake = st.text_input("Common Mistake to Avoid:")
                fl_action  = st.text_input("Concrete Action Tip (one next step):")
                if st.form_submit_button("📌 Publish Financial Note"):
                    masterclass_db.append({
                        "id": str(uuid.uuid4())[:8], "topic": fl_topic,
                        "stage": fl_stage, "summary": fl_summary,
                        "uganda_example": fl_uganda, "common_mistake": fl_mistake,
                        "action_tip": fl_action
                    })
            ...
            st.write("---")
            st.markdown("### ✏️ Edit Existing Lessons")
    ...
    # ── INTELLIGENCE DASHBOARD ────────────────────────────────────
        ...
        k1.metric("Service Cards",      total_gov_cards)
        k2.metric("Success Stories",    total_blueprints)
        k3.metric("Financial Lessons",  total_fl_lessons)
        k4.metric("Citizen Feedback",   total_feedback,   "Real data")
        k5.metric("Satisfaction",       f"{satisfaction_pct}%",
                  f"{helpful_count} helpful" if helpful_count else "No data yet")
        k6.metric("Friction Warnings",  friction_count,
                  "Needs attention" if friction_count > 0 else "All clear",
                  delta_color="inverse" if friction_count > 0 else "off")
        st.caption("Columns 1–3 from live content databases. Columns 4–6 from real citizen feedback.")

        st.markdown("---")

        # ── B. Content Coverage Gap Analysis ──────────────────────
        st.markdown("## B. Content Coverage Gap Analysis")
        st.caption("Which stage-sector combinations have NO service card?")
        ...
        with gc1:
            st.markdown(f"**Coverage: {len(covered)}/{len(all_combos)} combinations ({coverage_pct}%)**")
            st.progress(coverage_pct / 100)
            if gaps:
                st.markdown("**Gaps (no content yet):**")
                st.dataframe(pd.DataFrame(gaps, columns=["Stage","Sector"]),
        ...
        st.markdown("## C. Citizen Feedback (Live Data)")
        if st.session_state.feedback_log:
            ...
            with fc1:
                ...
                if "program" in df_fb.columns:
                    st.dataframe(df_fb.groupby(["program","status"]).size().unstack(fill_value=0),
                                 use_container_width=True)
            with fc2:
            ...
            if "status" in df_fb.columns:
                ...
                if not friction_df.empty:
                    st.markdown("**⚠️ Friction Warning Log**")
                    st.dataframe(friction_df, use_container_width=True)
                    st.warning(f"{len(friction_df)} friction warnings — review and simplify these programmes.")
            st.markdown("**Full Feedback Log**")
            st.dataframe(df_fb.sort_values("timestamp", ascending=False) if "timestamp" in df_fb.columns else df_fb,
                         use_container_width=True)
            st.download_button("⬇️ Download Log (CSV)", df_fb.to_csv(index=False),
                               "katali_feedback_log.csv", "text/csv")
        else:
            st.info("No citizen feedback yet. It will appear here automatically once citizens use the platform.")

        st.markdown("---")

        # ── D. Sector Demand Intelligence ─────────────────────────
        st.markdown("## D. Sector Demand Intelligence (Illustrative Projections)")
        st.caption("Illustrative projections based on Uganda MSME estimates. Will be replaced by real traffic data once deployed.")
        ...
        st.markdown("## E. Policy Intelligence")
        rc1, rc2 = st.columns(2)
        with rc1:
            st.markdown("**Automated Recommendations**")
            if gaps:
                st.warning(f"{len(gaps)} content gaps. Priority: {', '.join([f'{s}/{sec}' for s,sec in gaps[:3]])}")
            if friction_count > 0:
            ...
            if total_feedback == 0:
                st.info("No interaction data yet. Deploy QR codes at LC1 offices to begin generating real intelligence.")
            if total_gov_cards < 15:
                st.info(f"Content library has {total_gov_cards} service cards. Consider adding more for Mature MSME stage.")
        with rc2:
            st.markdown("**Platform Readiness**")
            checks = [
                ("Service cards",        total_gov_cards  >= 5,   f"{total_gov_cards} published"),
                ("Success stories",      total_blueprints >= 3,   f"{total_blueprints} published"),
                ("Financial lessons",    total_fl_lessons >= 10,  f"{total_fl_lessons} published"),
                ("Content coverage",     coverage_pct     >= 60,  f"{coverage_pct}% of combinations"),
                ("Citizen feedback",     True,                    "Active"),
                ("PDF downloads",        PDF_AVAILABLE,           "Available" if PDF_AVAILABLE else "fpdf2 not installed"),
                ("QR generator",         QR_AVAILABLE,            "Available" if QR_AVAILABLE else "qrcode not installed"),
            ]
            for label, passing, detail in checks:
                icon = "✅" if passing else "⚠️"
                st.markdown(f"{icon} **{label}** — {detail}")

        st.markdown("---")

        # ── F. LC1 Deployment Tools ───────────────────────────────
        st.markdown("## F. LC1 Deployment Tools")
        ftab1, ftab2 = st.tabs(["📄 Weekly Digest PDF", "📱 QR Code for LC1 Office"])
        ...
        with ftab1:
            ...
            if PDF_AVAILABLE:
                ...
                with fc1:
                    digest_district = st.text_input("District for header:",
                                                     value=profile.get("district",""),
                                                     placeholder="e.g. Kampala")
                    digest_stage = st.selectbox("Focus stage (or All):", ["All Stages"] + STAGES)
                with fc2:
                    n_gov = st.slider("Service cards:", 1, min(5, max(1,len(st.session_state.gov_db))), 3)
                    n_bp  = st.slider("Success stories:", 1, min(3, max(1,len(st.session_state.blueprint_db))), 2)
                    n_fl  = st.slider("Financial lessons:", 1, min(5, max(1,len(st.session_state.masterclass_db))), 3)
                if st.button("Generate Weekly Digest PDF"):
                    ...
                    if pdf_b:
                        st.download_button("⬇️ Download Digest PDF", data=pdf_b,
                                           file_name=f"katali_digest_{digest_district or 'all'}.pdf",
                                           mime="application/pdf")
            else:
                st.warning("PDF unavailable — ensure fpdf2 is in requirements.txt and redeploy.")

        with ftab2:
            st.markdown("Generate a QR code pointing to this platform. Print at A5 size, laminate, and post at any LC1 office, SACCO branch, or market notice board.")
            if QR_AVAILABLE:
                app_url = st.text_input("Enter your Streamlit app URL:",
                                         value="https://infoug.streamlit.app",
                                         placeholder="https://yourapp.streamlit.app")
                qr_label    = st.text_input("Label (shown below QR on printout):",
                                             value="Scan for Free Business Guidance — Katali Platform")
                qr_district = st.text_input("LC1 location label:",
                                             value=profile.get("district",""),
                                             placeholder="e.g. Namuwongo LC1 Office, Kampala")
                if st.button("Generate QR Code"):
                    if app_url.strip():
                        ...
                        if qr_bytes:
                            ...
                            st.download_button(
                                "⬇️ Download QR Code (PNG — print at A5 or larger)",
                                data=qr_bytes,
                                file_name=f"katali_qr_{qr_district.replace(' ','_') or 'lc1'}.png",
                                mime="image/png"
                            )
                            st.success("QR code ready. Print at A5 minimum, laminate, and post at the LC1 office.")
                            st.info("Citizens scan this and land directly on Katali — no app download needed.")
                    else:
                        st.warning("Please enter the app URL first.")
            else:
                st.warning("QR code unavailable — add qrcode[pil] and Pillow to requirements.txt and redeploy.")


    # ── USSD SIMULATOR ───────────────────────────────────────────
    elif view == "📟 USSD Simulator":
        branded_header('USSD Simulator', 'Low-tech access for basic mobile phones')
        st.info("💡 Emulating a USSD session over a basic feature-phone. Menus generated live from the current database.")
        ...
        with col_input:
            ...
            current_input = st.text_input(
                "Type numeric choices (e.g. 1 → 1*1 → 1*1*1):",
                value=st.session_state.ussd_string)
            st.session_state.ussd_string = current_input.strip()
            st.markdown("""
**Navigation:**
* Blank → Main menu
* `1` → Opportunities → Stage → Sector → Item
* `2` → Success Stories → Sector → Item
* `3` → Financial Literacy → Stage → Topic
* Menus reflect whatever is published via Content Management.
""")
        ...
        with col_screen:
            ...
            with st.container(border=True):
                ...
                def _safe_idx(parts, i):
                    if i < len(parts):
                        try:
                            v = int(parts[i]); return v if v >= 1 else None
                ...
                if not parts:
                    screen = "CON Welcome to Katali.\n1. Opportunities\n2. Success Stories\n3. Financial Literacy"
                elif parts[0] == "1":
                    stages_avail = [s for s in STAGES if any(c["stage"] == s for c in st.session_state.gov_db)]
                    if len(parts) == 1:
                        screen = ("CON Choose Stage:\n" + "\n".join(
                            f"{i+1}. {s}" for i,s in enumerate(stages_avail))) if stages_avail else "END No opportunities published yet."
                    else:
                        idx1 = _safe_idx(parts, 1)
                                ...
                                if idx2 and idx2 <= len(sectors_avail):
                                    ...
                                    if len(parts) == 3:
                                        if len(matches) == 1:
                                            ...
                                            screen = f"CON {sector} - Select:\n" + "\n".join(f"{i+1}. {c['title'][:30]}" for i,c in enumerate(matches))
                                        else:
                                            screen = "END No services found."
                                    else:
                                        idx3 = _safe_idx(parts, 3)
                    ...
                    if len(parts) == 1:
                        screen = ("CON Success Stories - Choose Sector:\n" + "\n".join(
    ...
    # ── SERVICE PREVIEW ──────────────────────────────────────────
        ...
        branded_header("Service Preview", "Citizen experience — Opportunities · Success Stories · Financial Literacy")
        if profile.get("name"):
            st.markdown(f"### 👋 {profile['name']} — content for **{profile.get('district', 'your district')}**")
        else:
            st.info("💡 Set up a citizen profile to see personalised content in this preview.")
        ...
        w_tab1, w_tab2, w_tab3 = st.tabs(["🎯 Opportunities", "⭐ Success Stories", "📚 Financial Literacy"])

        # ── Tab 1: Opportunities ─────────────────────────────────
        with w_tab1:
            col_nav1, col_nav2 = st.columns(2)
            with col_nav1:
                selected_stage  = st.selectbox("Stage:", ["Select Stage"] + STAGES,  index=default_stage_idx,  key="prev_stage")
                selected_sector = (st.selectbox("Sector:", ["Select Sector"] + SECTORS, index=default_sector_idx, key="prev_sector")
                                   if selected_stage != "Select Stage" else "Select Sector")
            with col_nav2:
                gov_search = st.text_input("🔍 Keyword search:", value="", key="prev_gov_search")
            ...
            with st.container(border=True):
                ...
                if matched_gov:
                    for card in matched_gov:
                        ...
                        with col_fb2:
                            if st.button("👎 Still confusing", key=f"no_g_{card['id']}"):
                                ...
                                save_json(FEEDBACK_FILE, st.session_state.feedback_log)
                                st.error("Feedback sent to optimisation queue.")
                        with col_dl:
                            if PDF_AVAILABLE:
                    ...
                    st.caption("Adjust filters above to display opportunities.")

        # ── Tab 2: Success Stories ───────────────────────────────
        with w_tab2:
            col_bp1, col_bp2 = st.columns(2)
            with col_bp1:
                selected_bp_sector = st.selectbox("Sector:", ["Select Sector"] + SECTORS, index=default_sector_idx, key="prev_bp_sec")
                selected_bp_tier   = (st.selectbox("Capital Tier:", ["Select Tier"] + CAPITAL_TIERS, key="prev_bp_tier")
                                      if selected_bp_sector != "Select Sector" else "Select Tier")
            with col_bp2:
                bp_search = st.text_input("🔍 Search:", value="", key="prev_bp_search")
            ...
            with st.container(border=True):
                ...
                if matched_bp:
                    ...
                    st.warning("Select a sector and capital tier, or search a keyword.")

        # ── Tab 3: Financial Literacy ────────────────────────────
        with w_tab3:
            st.markdown("#### ⚡ Quick Financial Check-In")
            st.caption("Answer 4 questions to get your most relevant lessons.")
            qc_stage = st.selectbox("Your business stage:", ["Select Stage"] + STAGES,
                                    key="qc_stage", index=default_stage_idx)
            qc_col1, qc_col2 = st.columns(2)
            with qc_col1:
                cash_flow      = st.radio("Current cash flow?", ["Positive","Breaking even","Negative"], key="qc_cash", horizontal=True)
                separate_money = st.radio("Business & personal money separated?", ["Yes","Sort of","No"],  key="qc_sep",  horizontal=True)
            with qc_col2:
                has_savings     = st.radio("Business savings set aside?", ["Yes","No"],  key="qc_save", horizontal=True)
                considering_loan= st.radio("Thinking about a loan soon?",  ["No","Yes"],  key="qc_loan", horizontal=True)

            if st.button("✅ Get My Recommendations"):
                if qc_stage == "Select Stage":
                    st.warning("Select your business stage first.")
                else:
                    def _find_lesson(stage, topic_candidates):
                    ...
                    if cash_flow == "Negative":
                        l = _find_lesson(qc_stage, CHECKIN_RULES["cash_flow_negative"])
                        if l: recommended.append(l)
                    if separate_money in ("No","Sort of"):
                        l = _find_lesson(qc_stage, CHECKIN_RULES["no_separation"])
                        if l: recommended.append(l)
                    if has_savings == "No":
                        l = _find_lesson(qc_stage, CHECKIN_RULES["no_savings"])
                        if l: recommended.append(l)
                    if considering_loan == "Yes":
                        l = _find_lesson(qc_stage, CHECKIN_RULES["considering_loan"])
                        if l: recommended.append(l)
                    seen_ids = set()
                    recommended = [r for r in recommended if not (r["id"] in seen_ids or seen_ids.add(r["id"]))]
                    if not recommended:
                        fallback = _find_lesson(qc_stage, ["Investing & Growing Your Capital"])
                    ...
                    for m in recommended:
                        ...
                        if PDF_AVAILABLE:
                            pdf_bytes = generate_masterclass_pdf(m, profile, local_ctx or "")
                            if pdf_bytes:
                                st.download_button("📄 Download PDF", data=pdf_bytes,
        ...
        st.caption("Searches all three databases simultaneously.")
        ai_prompt = st.text_input("Search all databases (e.g. 'rabbit farm funding', 'register URSB'):", key="prev_xsearch")
        if ai_prompt:
            q_lower = ai_prompt.lower()
            _mg = [c for c in st.session_state.gov_db if any(
                w in c.get("title","").lower() or w in c.get("sector","").lower() or w in c.get("agency","").lower()
                for w in q_lower.split())]
            _mb = [b for b in st.session_state.blueprint_db if any(
                w in b.get("title","").lower() or w in b.get("summary","").lower() or w in b.get("success_case","").lower()
                for w in q_lower.split())]
            _mf = [m for m in st.session_state.masterclass_db if any(
            ...
            with st.chat_message("assistant"):
                ...
                with c1:
                    ...
                    if _mg:
                        st.markdown(f"**{_mg[0].get('title')}**")
                        st.caption(f"{_mg[0].get('agency')} · {_mg[0].get('cost')}")
                    else: st.write("No match.")
                with c2:
                    st.markdown("**⭐ Success Stories**")
                    if _mb:
                        st.markdown(f"**{_mb[0].get('title')}**")
                        st.info(f"💡 {_mb[0].get('fin_lit_tip')}")
                    else: st.write("No match.")
                with c3:
                    st.markdown("**📚 Financial Literacy**")
                    if _mf:
                        st.markdown(f"**{_mf[0].get('topic')}** ({_mf[0].get('stage')})")
                        st.info(f"✅ {_mf[0].get('action_tip')}")
                    else: st.write("No match.")
